...
#include "JoinSessionGameCallbackProxy.generated.h"

class APlayerController;

UCLASS(MinimalAPI, meta = (ShortTooltip = "Join a GameSession for SteamParty"))
class UJoinSessionGameCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	static UJoinSessionGameCallbackProxy* JoinSessionGame(UObject* WorldContextObject, class APlayerController* PlayerController, const FBlueprintSessionResult& SearchResult);
