...
#include "FindSessionsGameCallbackProxy.generated.h"

class APlayerController;

UCLASS(MinimalAPI, meta = (ShortTooltip = "Find a GameSession for SteamParty"))
class UFindSessionsGameCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	static UFindSessionsGameCallbackProxy* FindSessionsGame(UObject* WorldContextObject, class APlayerController* PlayerController, int32 MaxResults, bool bUseLAN, const FString& InGameType = FString(TEXT("ALL")));
