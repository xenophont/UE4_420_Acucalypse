...
#include "JoinSessionPartyCallbackProxy.generated.h"

class APlayerController;

UCLASS(MinimalAPI, meta = (ShortTooltip = "Join a PartySession for SteamParty"))
class UJoinSessionPartyCallbackProxy : public UOnlineBlueprintCallProxyBase
{
	...
	static UJoinSessionPartyCallbackProxy* JoinSessionParty(UObject* WorldContextObject, class APlayerController* PlayerController, const FBlueprintSessionResult& SearchResult);
